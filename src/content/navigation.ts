...
export const footerLinks = {
  ...
  industries: [
    ...
    { label: "Dough Sheet / Dried Noodle", href: "/industries/grain-noodle-processing" },
    { label: "Calcium Carbonate", href: "/industries/soda-ash-bicarbonate-calcium-carbonate" },
    { label: "Baking Soda", href: "/industries/baking-soda" },
    { label: "Soda Ash", href: "/industries/soda-ash" },
    { label: "Rubber Additives", href: "/industries/rubber-additives" },
    { label: "Dextrin", href: "/industries/dextrin" },
